...
namespace AVS.Tools.WPF
{
    ...
    public class FileToIconConverter : IValueConverter
    {
        ...
        public int DefaultSize { get { return m_defaultsize; } set { m_defaultsize = value; } }
        ...
        {
            if (value is string)
                return GetImage(value as string, m_defaultsize);
            else return GetImage("", m_defaultsize);
        }
